...
ASSET_FILETYPE_TO_TITLE = {
    ...
    "_HH_sigma0.tif": "HH_sigma0",
    "_HV_sigma0.tif": "HV_sigma0",
    "_VV_sigma0.tif": "VV_sigma0",
    "_VH_sigma0.tif": "VH_sigma0",
    "_HH_beta0.tif": "HH_beta0",
    "_HV_beta0.tif": "HV_beta0",
    "_VV_beta0.tif": "VV_beta0",
    "_VH_beta0.tif": "VH_beta0",
...
ASSET_FILETYPE_TO_DESCRIPTION = {
    ...
    "_HV_sigma0.tif": "HV polarised sigma0 linear backscatter",
    "_VV_sigma0.tif": "VV polarised sigma0 linear backscatter",
    "_VH_sigma0.tif": "VH polarised sigma0 linear backscatter",
    "_HH_beta0.tif": "HH polarised beta0 linear backscatter",
    "_HV_beta0.tif": "HV polarised beta0 linear backscatter",
    "_VV_beta0.tif": "VV polarised beta0 linear backscatter",
    "_VH_beta0.tif": "VH polarised beta0 linear backscatter",
...
ASSET_FILETYPE_TO_ROLES = {
    ...
    "_HH_sigma0.tif": ["data", "backscatter"],
    "_HV_sigma0.tif": ["data", "backscatter"],
    "_VV_sigma0.tif": ["data", "backscatter"],
    "_VH_sigma0.tif": ["data", "backscatter"],
    "_HH_beta0.tif": ["data", "backscatter"],
    "_HV_beta0.tif": ["data", "backscatter"],
    "_VV_beta0.tif": ["data", "backscatter"],
    "_VH_beta0.tif": ["data", "backscatter"],
...
ASSET_FILETYPE_TO_MEDIATYPE = {
    ...
    "_HH_sigma0.tif": pystac.media_type.MediaType.COG,
    "_HV_sigma0.tif": pystac.media_type.MediaType.COG,
    "_VV_sigma0.tif": pystac.media_type.MediaType.COG,
    "_VH_sigma0.tif": pystac.media_type.MediaType.COG,
    "_HH_beta0.tif": pystac.media_type.MediaType.COG,
    "_HV_beta0.tif": pystac.media_type.MediaType.COG,
    "_VV_beta0.tif": pystac.media_type.MediaType.COG,
    "_VH_beta0.tif": pystac.media_type.MediaType.COG,
