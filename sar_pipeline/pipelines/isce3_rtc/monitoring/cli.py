...
from sar_pipeline.pipelines.isce3_rtc.monitoring.s1_iw_completeness import (
...
@click.option(
    ...
    "{s3_bucket}/{s3_report_folder}/{report_time}_{start_time}_{end_time}_completion_report.json "
